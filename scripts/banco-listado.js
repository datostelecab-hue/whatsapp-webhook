...
// -- Planificador V2: RETIRADO ---------------------------------------------
// El banco pintaba el tablero con filas inventadas usando `calcularTablero`.
// Ese motor se borro el 15/09/2026: la pantalla la calcula ahora
// `Planificacion/planificador.repo` con SQL, que no se puede alimentar con
// filas de mentira sin levantar una base.

app.listen(4599, () => console.log('Banco: http://localhost:4599/vehiculos · /plantilla'));
